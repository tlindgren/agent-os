...
1. Create directory: `_project-docs/planning/[feature-name]/`
2. Write PRD to: `_project-docs/planning/[feature-name]/prd.md`
3. Copy handoff log template from: `.ai-rules/rules/claude-gemini-workflow/templates/handoff-log-template.md`
4. Save handoff log to: `_project-docs/planning/[feature-name]/handoff-log.md`
5. Add initial entry to handoff log documenting spec creation

**Example:**
```
_project-docs/planning/user-authentication/
├── prd.md                # Full specification (you write this)
└── handoff-log.md        # Collaboration tracking (you initialize this)
```
